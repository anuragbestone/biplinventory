...
Route::middleware("AuthInCheck", "RoleCheck")->group(function() {
    ...
    Route::middleware("CheckShift")->group(function() {
        ...
        Route::get("/warehouse/getRmPmStockAvailableDataByFgID", [WarehouseController::class, "getRmPmStockAvailableDataByFgID"])->name("warehouse/getRmPmStockAvailableDataByFgID");
    ...
    Route::post("/updateModulePermission", [PermissionsController::class, "updateModulePermission"]);
    
    Route::get("/email", [EmailController::class, "email"]);
    Route::post("/generateEmailTemplate", [EmailController::class, "generateEmailTemplate"]);
